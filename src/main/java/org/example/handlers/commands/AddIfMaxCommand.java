...
public class AddIfMaxCommand extends Command{
    ...
    public String getCommandInfo() {
        return "Добавить музыкальную группу в коллекцию, если количество участников больше, чем у максимальной группы в коллекции";
    }
    ...
    public void execute(String... args) {
        ...
        try {
            ...
            long maxNumberOfParticipants = 0;
            ...
            if (Long.parseLong(numberOfParticipants) <= 0) {
            ...
            } else if (Long.parseLong(numberOfParticipants) > maxNumberOfParticipants) {
                ...
                invoker.getPrinter().print("В коллекции есть группа с большим количеством участников!");
            }
        }
